        ...
        <div className='container mt-5 mb-5'>
            <div className='row p-2'>
                ...
                <div className='col-6 p-3'>
                    ...
                    <a href='demat' style={{ textDecoration: "none", color: "#1a73e8", fontWeight: "500" }}>Varsity <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a>
                    <br></br>
                    <br></br>
                    <br></br>
                    ...
                    <a href="demat" style={{ textDecoration: "none", color: "#1a73e8", fontWeight: "500" }}>TradingQ&A <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                </div>                
            </div>
        </div>
     );
