      ...
      <div className="container">
        <div className="row mt-4">
          <div className="col-3 pt-2 me-5">
            ...
            <p className="d-flex gap-4 flex-wrap mt-3">
              <i class="fa fa-twitter fs-4 text-muted" aria-hidden="true"></i>
              <i class="fa fa-facebook fs-4 text-muted" aria-hidden="true"></i>
              <i class="fa fa-instagram fs-4 text-muted" aria-hidden="true"></i>
              <i class="fa fa-linkedin fs-4 text-muted" aria-hidden="true"></i>
              </p>
              <hr></hr>
              <p className="d-flex gap-4 flex-wrap mt-3">
                  <i class="fa fa-youtube-play fs-4 text-muted" aria-hidden="true"></i>
                  <i class="fa fa-whatsapp fs-4 text-muted" aria-hidden="true"></i>
                  <i class="fa fa-telegram fs-4 text-muted" aria-hidden="true"></i>
              </p>
          </div>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <div className="mt-4 text-muted d-flex text-center" style={{ fontSize: "14px", marginLeft:"20px" }}>
              ...
              <ul>Policies & procedures</ul>
              <ul>Privacy policy </ul>
              <ul>Disclosure</ul>
              <ul>For investor's attention</ul>
              <ul>Investor charter</ul>
          </div>
      </div>
    </div>
    </footer>
